...
{
    [Fact]
    public async Task SortingService_ShouldReturnAdsSortedByCreatedDateDesc_WhenParamsNotProvided()
    {
        //Arrange
    ...
    [Fact]
    public async Task SortingService_ShouldReturnAdsSortedByPriceAscending_WhenSortingParamsProvidedInAnyCase()
    {
        //Arrange
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task SortingService_ShouldReturnAdsSortedByCreatedDateDesc_WhenWrongParamsProvided()
    {
        //Arrange
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task SortingService_ShouldReturnAdsSortedByDescending_WhenNoSortingOrderParamProvided()
    {
        //Arrange
        var fixture = new Fixture();
